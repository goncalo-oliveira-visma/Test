...
class BaseExpression:
    ...
    def get_expression_for_validation(self): # -> Self:
        ...
...
class F(Combinable):
    ...
    def __getitem__(self, subscript): # -> Sliced:
        ...
...
class DatabaseDefault(Expression):
    ...
    def resolve_expression(self, query=..., allow_joins=..., reuse=..., summarize=..., for_save=...): # -> DatabaseDefault:
        ...
    
    def as_sql(self, compiler, connection): # -> tuple[Literal['DEFAULT'], list[Any]]:
        ...
...
class ExpressionList(Func):
    ...
    def as_sqlite(self, compiler, connection, **extra_context): # -> tuple[Literal[''], tuple[()]] | tuple[Any, list[Any]]:
        ...
...
class When(Expression):
    ...
    def get_source_expressions(self): # -> list[Any | Q | F | Value]:
        ...
...
class Exists(Subquery):
    ...
    def as_sql(self, compiler, *args, **kwargs): # -> tuple[Any, Any] | tuple[Literal['1=0'], tuple[()]]:
        ...
...
class Window(SQLiteNumericMixin, Expression):
    ...
    def get_source_expressions(self): # -> list[Any | F | Value | tuple[Any] | ExpressionList | OrderByList | None]:
        ...
...
class WindowFrame(Expression):
    ...
    """
    template = ...
    def __init__(self, start=..., end=..., exclusion=...) -> None:
        ...
    ...
    def get_exclusion(self): # -> LiteralString | Literal['']:
        ...
