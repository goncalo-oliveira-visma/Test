...
class RelatedField(FieldCacheMixin, Field):
    ...
    def get_reverse_related_filter(self, obj): # -> Node:
        """
    ...
    def get_limit_choices_to(self): # -> object:
        """
...
class ForeignObject(RelatedField):
    ...
    def resolve_related_fields(self): # -> list[Any]:
        ...
    
    @cached_property
    def related_fields(self): # -> list[Any]:
        ...
    
    @cached_property
    def reverse_related_fields(self): # -> list[tuple[Any, Any]]:
        ...
    
    @cached_property
    def local_related_fields(self): # -> tuple[Any, ...]:
        ...
    
    @cached_property
    def foreign_related_fields(self): # -> tuple[Any, ...]:
        ...
    
    def get_local_related_value(self, instance): # -> tuple[Any, ...]:
        ...
    
    def get_foreign_related_value(self, instance): # -> tuple[Any, ...]:
        ...
    
    @staticmethod
    def get_instance_value_for_fields(instance, fields): # -> tuple[Any, ...]:
        ...
    
    def get_attname_column(self): # -> tuple[Any | None, None]:
        ...
    
    def get_joining_columns(self, reverse_join=...): # -> tuple[tuple[Any, Any], ...]:
        ...
    
    def get_reverse_joining_columns(self): # -> tuple[tuple[Any, Any], ...]:
        ...
    
    def get_joining_fields(self, reverse_join=...): # -> tuple[Any, ...]:
        ...
    
    def get_reverse_joining_fields(self): # -> tuple[Any, ...]:
        ...
    
    def get_extra_descriptor_filter(self, instance): # -> dict[Any, Any]:
        """
...
class ForeignKey(ForeignObject):
    ...
    def get_attname_column(self): # -> tuple[Any, Any]:
        ...
    ...
    def db_parameters(self, connection): # -> dict[str, Any | None]:
        ...
...
class ManyToManyField(RelatedField):
    ...
    def get_path_info(self, filtered_relation=...): # -> list[Any]:
        ...
    
    @cached_property
    def path_infos(self): # -> list[Any]:
        ...
    
    def get_reverse_path_info(self, filtered_relation=...): # -> list[Any]:
        ...
    
    @cached_property
    def reverse_path_infos(self): # -> list[Any]:
        ...
