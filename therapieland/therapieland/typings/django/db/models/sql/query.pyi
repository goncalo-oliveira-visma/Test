...
def get_field_names_from_opts(opts): # -> set[Any]:
    ...

def get_paths_from_expression(expr): # -> Generator[Any, Any, None]:
    ...

def get_children_from_q(q): # -> Generator[Any, Any, None]:
    ...

def get_child_with_renamed_prefix(prefix, replacement, child): # -> Node | tuple[Any, Node | tuple[Any, Node | tuple[Any, F | Any] | F | Any] | F | Any] | F:
    ...

def rename_prefix_from_q(prefix, replacement, q): # -> Node:
    ...
...
class RawQuery:
    ...
    @property
    def params_type(self): # -> type[dict[Any, Any]] | type[tuple[Any, ...]] | None:
        ...
...
class Query(BaseExpression):
    ...
    def get_aggregation(self, using, aggregate_exprs): # -> dict[Any, Any]:
        """
    ...
    def table_alias(self, table_name, create=..., filtered_relation=...): # -> tuple[Any, Literal[False]] | tuple[str | Any, Literal[True]]:
        """
    ...
    def change_aliases(self, change_map): # -> Self | None:
        """
    ...
    def add_annotation(self, annotation, alias, select=...): # -> None:
    ...
    def get_external_cols(self): # -> list[Col | Any]:
        ...
    
    def get_group_by_cols(self, wrapper=...): # -> list[Any | Self] | list[Col | Any]:
        ...
    
    def as_sql(self, compiler, connection): # -> tuple[Any, Any]:
        ...
    
    def resolve_lookup_value(self, value, can_reuse, allow_joins, summarize=...): # -> list[Any] | tuple[Any, ...]:
        ...
    
    def solve_lookup_type(self, lookup, summarize=...): # -> tuple[Any | tuple[()], tuple[()], Ref | Any] | tuple[Any, Any, Literal[False]]:
        """
    ...
    def build_filter(self, filter_expr, branch_negated=..., current_negated=..., can_reuse=..., allow_joins=..., split_subq=..., check_filterable=..., summarize=..., update_join_types=...):
        """
    ...
    def names_to_path(self, names, opts, allow_many=..., fail_on_missing=...): # -> tuple[list[Any], Any, Any | tuple[Any], Any]:
        """
    ...
    def setup_joins(self, names, opts, alias, can_reuse=..., allow_many=...): # -> JoinInfo:
        """
    ...
    def trim_joins(self, targets, joins, path): # -> tuple[Any | tuple[Any, ...], Any, Any]:
        """
    ...
    def split_exclude(self, filter_expr, can_reuse, names_with_path): # -> tuple[Any, Any]:
        """
...
def get_order_dir(field, default=...): # -> tuple[Any, str]:
    """
...
class JoinPromoter:
    ...
    def update_join_types(self, query): # -> set[Any]:
        """
