...
class Lookup(Expression):
    ...
    def get_source_expressions(self): # -> list[Any | Value]:
        ...
    ...
    @property
    def identity(self): # -> tuple[type[Self], Any | Value, Any | Value]:
        ...
...
class FieldGetDbPrepValueIterableMixin(FieldGetDbPrepValueMixin):
    ...
    def process_rhs(self, compiler, connection): # -> tuple[tuple[Any, ...], tuple[Any, ...]]:
        ...
    
    def resolve_expression_parameter(self, compiler, connection, sql, param): # -> tuple[Any, Any | list[Any]]:
        ...
    
    def batch_process_rhs(self, compiler, connection, rhs=...): # -> tuple[tuple[Any, ...], tuple[Any, ...]]:
        ...
