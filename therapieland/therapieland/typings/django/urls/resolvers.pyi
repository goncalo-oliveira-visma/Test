...
class RegexPattern(CheckURLMixin):
    ...
    def match(self, path): # -> tuple[Any, tuple[()] | Any, dict[Any, Any]] | None:
        ...
...
class RoutePattern(CheckURLMixin):
    ...
    def match(self, path): # -> tuple[Any, tuple[()], Any] | None:
        ...
    
    def check(self): # -> list[Any | Warning]:
        ...
...
class LocalePrefixPattern:
    ...
    def match(self, path): # -> tuple[Any, tuple[()], dict[Any, Any]] | None:
        ...
...
class URLPattern:
    ...
    def check(self): # -> list[Warning] | list[Any]:
        ...
...
class URLResolver:
    ...
    @cached_property
    def urlconf_module(self): # -> ModuleType | Any:
        ...
    ...
    def resolve_error_handler(self, view_type): # -> Callable[..., object]:
        ...
