...
class UsernameField(forms.CharField):
    ...
    def widget_attrs(self, widget): # -> dict[Any | str, Any | str]:
        ...
...
class SetUnusablePasswordMixin:
    ...
    def validate_passwords(self, password1_field_name=..., password2_field_name=..., usable_password_field_name=...): # -> None:
        ...
