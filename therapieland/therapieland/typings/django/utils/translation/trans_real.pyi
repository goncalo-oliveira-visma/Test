...
class TranslationCatalog:
    ...
    def items(self): # -> Generator[tuple[Any, Any] | Any, Any, None]:
        ...
...
def gettext(message): # -> _Wrapped[..., object, ..., Any | _Wrapped[..., Any, ..., Any] | SafeString] | SafeString | Any:
    """
...
def pgettext(context, message): # -> _Wrapped[..., object, ..., Any | _Wrapped[..., Any, ..., Any] | SafeString] | SafeString | Any | str:
    ...
...
def all_locale_paths(): # -> list[str | Any]:
    """
...
def parse_accept_lang_header(lang_string): # -> tuple[()] | tuple[Any, ...]:
    """
