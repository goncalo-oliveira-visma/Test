...
def int_to_base36(i): # -> LiteralString | Literal['']:
...
def parse_header_parameters(line): # -> tuple[Any, dict[Any, Any]]:
    """
...
def content_disposition_header(as_attachment, filename): # -> str | None:
    """
